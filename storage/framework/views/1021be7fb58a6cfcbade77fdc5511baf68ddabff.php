                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <?php if(isset($row->json_params->taxonomy_title->$lang)): ?>
                      <td>
                        <?php echo e($row->json_params->taxonomy_title->$lang); ?>
                      ...
                      <td class="wrap-load-hot" data-url="<?php echo e(route('admin.cms_posts.load.isFeatured',['id'=>$row->id])); ?>">
                      ...
                      <td>
                        ...
                        <input data-url="<?php echo e(route('admin.loadOrderVeryModel',['table'=>'cms_posts','id'=>$row->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($row->iorder?$row->iorder:0); ?>" style="width:50px" />
                      </td>
                      <td>
                      ...
                      <td class="wrap-load-active" data-url="<?php echo e(route('admin.cms_posts.load.status',['id'=>$row->id])); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\biasg\resources\views/admin/pages/cms_posts/index.blade.php ENDPATH**/ ?>