...
<script src="{{ asset('themes/frontend/biasg/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('themes/frontend/biasg/js/jquery.js') }}"></script>
<script async src="{{ asset('themes/frontend/biasg/js/style.js') }}"></script>
<script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
