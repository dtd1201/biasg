                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[description][{{$lang}}]" id="description" class="form-control" rows="5">{{ old('description') ?? ($detail->json_params->description->$lang??( $detail->json_params->description->$lang ?? $detail->description)) }}</textarea>
                                        </div>
                                    </div>
                            ...
                            <form action="{{ route(Request::segment(2) . '.store') }}" method="POST" id="form-main"
                                ...
                                <div class="d-flex-wap">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('Description')</label>
                                            <textarea name="json_params[description][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control" rows="5">{{ old('description') ?? '' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('Brief')</label>
                                            <textarea name="json_params[brief][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control" rows="5">{{ old('brief') ?? '' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('Content')</label>
                                            <textarea name="json_params[content][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control" rows="5">{{ old('content') ?? '' }}</textarea>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <div class="tab-pane active">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <label>@lang('Description')</label>
                                                                                    <textarea name="json_params[description][{{$lang}}]" id="description" class="form-control" rows="5">{{ old('description') ?? ($item->json_params->description->$lang??( $item->json_params->description->$lang ?? $item->description)) }}</textarea>
                                                                                </div>
                                                                            </div>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-md-6">
                                                                                                    <div
                                                                                                        class="form-group">
                                                                                                        <label>@lang('Description')</label>
                                                                                                        <textarea name="json_params[description][{{$lang}}]"  class="form-control" rows="5">{{ old('description') ?? ( $item_sub_1->json_params->description->$lang ?? $item_sub_1->description) }}</textarea>
