                                ...
                                <div class="d-flex-wap">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[map]" class="form-control" rows="5">{{ old('json_params[map]') ?? '' }}</textarea>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <div class="tab-pane active">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <label>@lang('Map')</label>
                                                                                    <textarea name="json_params[map]" class="form-control" rows="5">{{ old('json_params[map]') ?? ($items->json_params->map ?? '') }}</textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <label>@lang('Map')</label>
                                                                                                    <textarea name="json_params[map]" class="form-control" rows="5">{{ old('json_params[map]') ?? ($item_sub_1->json_params->map ?? '') }}</textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <div class="form-group">
