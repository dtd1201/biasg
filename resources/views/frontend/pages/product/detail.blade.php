...
@section('content')
  ...
  <div id="content">
    ...
    <section id="banner-video" style="background-image: url('@if(isset($detail->json_params->image_background_video)){{ $detail->json_params->image_background_video }} @endif')">
      <div class="video-detail">
        <iframe width="80%" height="600" src="@if(isset($detail->json_params->link_yt)){{ $detail->json_params->link_yt }} @endif" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
      <div class="video-infor w-100">
        <div class="btn-play text-center">
    ...
    <section id="product-intro" style="background-image: url('@if(isset($detail->json_params->image_background_top)){{ $detail->json_params->image_background_top }} @endif')">
      <div class="container">
        <div class="intro-wrap">
          ...
          <ul class="d-flex align-items-center list-unstyled p-0 m-0">
            <li>
              {{ $alcohol }} <div>%@lang('Alcohol')</div>
            </li>
            <li>
              {{ $bottles }} <div>@lang('Bottles/safes')</div>
            </li>
            <li>
              {{ $cans }} <div>@lang('Cans/barrels')</div>
            </li>
          </ul>
        </div>
      </div>
    </section>
    <section id="product-infor" style="background-image: url('@if(isset($detail->json_params->image_background_bottom)){{ $detail->json_params->image_background_bottom }} @endif')" >
      <div class="container">
