                ...
                <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-4">
                          ...
                          <input type="text" class="form-control" name="json_params[alcohol]"
                            placeholder="@lang('Alcohol')"
                            @if(isset($detail->json_params->alcohol)) value="{{ $detail->json_params->alcohol ?? old('json_params[alcohol]') }}" @endif>
                        </div>
                        <div class="col-xs-4">
                          <label>@lang('Bottles/safes')</label>
                          <input type="text" class="form-control" name="json_params[bottles]"
                            placeholder="@lang('Bottles/safes')"
                            @if(isset($detail->json_params->bottles)) value="{{ $detail->json_params->bottles ?? old('json_params[bottles]') }}" @endif>
                        </div>
                        <div class="col-xs-4">
                          <label>@lang('Cans/barrels')</label>
                          <input type="text" class="form-control" name="json_params[cans]"
                            placeholder="@lang('Cans/barrels')"
                            @if(isset($detail->json_params->cans)) value="{{ $detail->json_params->cans ?? old('json_params[cans]') }}" @endif>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>@lang('Image background video')</label>
                          <div class="input-group">
                            ...
                            <input id="image_background_video" class="form-control" type="text" name="json_params[image_background_video]"
                              placeholder="@lang('image_link')..." @if(isset($detail->json_params->image_background_video)) value="{{ $detail->json_params->image_background_video }}" @endif>
                          </div>
                          <div id="image_background_video-holder" style="margin-top:15px;max-height:100px;">
                            @if (isset($detail->json_params->image_background_video) != '')
                              <img style="height: 5rem;" src="{{ $detail->json_params->image_background_video }}">
                            @endif
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="json_params[link_yt]"
                            ...
                            @if(isset($detail->json_params->link_yt)) value="{{ $detail->json_params->link_yt ?? old('json_params[link_yt]') }}" @endif>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input id="image_logo" class="form-control" type="text" name="image_logo"
                              placeholder="@lang('image_link')..." value="{{ $detail->image_logo }}">
                          </div>
                          <div id="image_logo-holder" style="margin-top:15px;max-height:100px;">
                            @if ($detail->image_logo != '')
                              <img style="height: 5rem;" src="{{ $detail->image_logo }}">
                            @endif
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>@lang('Image background top')</label>
                          <div class="input-group">
                            <span class="input-group-btn">
                            ...
                            <input id="image_background_top" class="form-control" type="text" name="json_params[image_background_top]"
                              placeholder="@lang('image_link')..." @if(isset($detail->json_params->image_background_top)) value="{{ $detail->json_params->image_background_top }}" @endif>
                          </div>
                          <div id="image_background_top-holder" style="margin-top:15px;max-height:100px;">
                            @if (isset($detail->json_params->image_background_top) != '')
                              <img style="height: 5rem;" src="{{ $detail->json_params->image_background_top }}">
                            @endif
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>@lang('Image background bottom')</label>
                          <div class="input-group">
                            <span class="input-group-btn">
                            ...
                            <input id="image_background_bottom" class="form-control" type="text" name="json_params[image_background_bottom]"
                              placeholder="@lang('image_link')..." @if(isset($detail->json_params->image_background_bottom)) value="{{ $detail->json_params->image_background_bottom }}" @endif>
                          </div>
                          <div id="image_background_bottom-holder" style="margin-top:15px;max-height:100px;">
                            @if (isset($detail->json_params->image_background_bottom) != '')
                              <img style="height: 5rem;" src="{{ $detail->json_params->image_background_bottom }}">
                            @endif
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="json_params[description][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control" id="description_vi" >{{ isset($detail->json_params->description->$lang) ? $detail->json_params->description->$lang : old('json_params[description][' . $lang != '' ? $lang : $languageDefault->lang_code . ']') }}</textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
