            ...
            <ul class="nav nav-tabs">
              ...
              <li>
                <a href="#tab_4" data-toggle="tab">
                  <h5><?php echo app('translator')->get('Attribute product'); ?></h5>
                </a>
              </li>
                ...
                <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-4">
                          ...
                          <input type="text" class="form-control" name="json_params[alcohol]"
                            placeholder="<?php echo app('translator')->get('Alcohol'); ?>" value="<?php echo e(old('json_params[alcohol]')); ?>">
                        </div>
                        <div class="col-xs-4">
                          <label><?php echo app('translator')->get('Bottles/safes'); ?></label>
                          <input type="text" class="form-control" name="json_params[bottles]"
                            placeholder="<?php echo app('translator')->get('Alcohol'); ?>" value="<?php echo e(old('json_params[bottles]')); ?>">
                        </div>
                        <div class="col-xs-4">
                          <label><?php echo app('translator')->get('Cans/barrels'); ?></label>
                          <input type="text" class="form-control" name="json_params[cans]"
                            placeholder="<?php echo app('translator')->get('Cans/barrels'); ?>" value="<?php echo e(old('json_params[cans]')); ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div id="image_background_video-holder" style="margin-top:15px;max-height:100px;">
                            <?php if(old('image_background_video') != ''): ?>
                              <img style="height: 5rem;" src="<?php echo e(old('image_background_video')); ?>">
                            <?php endif; ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="json_params[link_yt]"
                            placeholder="Link youtube" value="<?php echo e(old('json_params[link_yt]')); ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div id="image_logo-holder" style="margin-top:15px;max-height:100px;">
                            <?php if(old('image_logo') != ''): ?>
                              <img style="height: 5rem;" src="<?php echo e(old('image_logo')); ?>">
                            <?php endif; ?>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div id="image_background_top-holder" style="margin-top:15px;max-height:100px;">
                            <?php if(old('image_background_top') != ''): ?>
                              <img style="height: 5rem;" src="<?php echo e(old('image_background_top')); ?>">
                            <?php endif; ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div id="image_background_bottom-holder" style="margin-top:15px;max-height:100px;">
                            <?php if(old('image_background_bottom') != ''): ?>
                              <img style="height: 5rem;" src="<?php echo e(old('image_background_bottom')); ?>">
                            <?php endif; ?>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="json_params[description][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]" class="form-control"
                            id="description_vi"><?php echo e(old('json_params[description][' . $lang != '' ? $lang : $languageDefault->lang_code . ']')); ?></textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('.add-gallery-video').click(function(event) {
        ...
        let elementAppend = '';
        elementAppend += '<div class="col-lg-2 col-md-3 col-sm-4 mb-1 gallery-video gallery-image my-15">';
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\biasg\resources\views/admin/pages/cms_products/create.blade.php ENDPATH**/ ?>