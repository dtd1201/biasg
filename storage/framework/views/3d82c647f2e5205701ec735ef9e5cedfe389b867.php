              ...
              <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <form action="<?php echo e(route(Request::segment(2) . '.destroy', $admin->id)); ?>" method="POST"
                  ...
                  <tr class="valign-middle">
                    ...
                    <td class="wrap-load-active" data-url="<?php echo e(route('admin.admins.load.status',['id'=>$admin->id])); ?>">
                        <?php echo $__env->make('admin.components.load-change-status',['data'=>$admin,'type'=>'admin'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                      </td>
                    <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\honey\resources\views/admin/pages/admins/index.blade.php ENDPATH**/ ?>