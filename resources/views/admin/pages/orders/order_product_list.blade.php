      ...
      <div class="box-body table-responsive">
        ...
        @else
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                <th>@lang('General information')</th>
                ...
                <form action="{{ route(Request::segment(2) . '.destroy', $row->id) }}" method="POST"
                  ...
                  <tr class="valign-middle">
                    <td>
                      ...
                      <ul>
                        <li><strong>@lang('Fullname'):</strong> {{ $row->name }}</li>
                        <li><strong>@lang('Email'):</strong> {{ $row->email }}</li>
                        <li><strong>@lang('Phone'):</strong> {{ $row->phone }}</li>
                        <li><strong>@lang('Content note'):</strong>  {{ Str::limit($row->customer_note??'không có', 200) }}</li>
                      </ul>
                    </td>
                    <td>
                      {{ $row->total_quantity }}
