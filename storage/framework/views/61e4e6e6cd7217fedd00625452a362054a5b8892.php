      ...
      <div class="box-body table-responsive">
        ...
        <?php else: ?>
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                <th><?php echo app('translator')->get('General information'); ?></th>
                ...
                <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                  ...
                  <tr class="valign-middle">
                    <td>
                      ...
                      <ul>
                        <li><strong><?php echo app('translator')->get('Fullname'); ?>:</strong> <?php echo e($row->name); ?></li>
                        <li><strong><?php echo app('translator')->get('Email'); ?>:</strong> <?php echo e($row->email); ?></li>
                        <li><strong><?php echo app('translator')->get('Phone'); ?>:</strong> <?php echo e($row->phone); ?></li>
                        <li><strong><?php echo app('translator')->get('Content note'); ?>:</strong>  <?php echo e(Str::limit($row->customer_note??'không có', 200)); ?></li>
                      </ul>
                    </td>
                    <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\honey\resources\views/admin/pages/orders/order_product_list.blade.php ENDPATH**/ ?>