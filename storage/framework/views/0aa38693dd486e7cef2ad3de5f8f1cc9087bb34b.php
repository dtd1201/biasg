                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <td class="wrap-load-hot" data-url="<?php echo e(route('admin.cms_products.load.isFeatured',['id'=>$row->id])); ?>">
                      ...
                      <td>
                        ...
                        <input data-url="<?php echo e(route('admin.loadOrderVeryModel',['table'=>'cms_products','id'=>$row->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($row->iorder?$row->iorder:0); ?>" style="width:50px" />
                      </td>
                      <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\biasg\resources\views/admin/pages/cms_products/index.blade.php ENDPATH**/ ?>