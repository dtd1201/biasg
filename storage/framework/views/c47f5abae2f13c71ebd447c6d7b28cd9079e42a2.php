                  ...
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <td>
                        ...
                        <input data-url="<?php echo e(route('admin.loadOrderVeryModel',['table'=>'block_contents','id'=>$row->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($row->iorder?$row->iorder:0); ?>" style="width:50px" />
                      </td>
                      <td>
                      ...
                      <td class="wrap-load-active" data-url="<?php echo e(route('admin.block_contents.load.status',['id'=>$row->id])); ?>">
                        <?php echo $__env->make('admin.components.load-change-status',['data'=>$row,'type'=>'Khối nội dung'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                      </td>
                      <td>
                      ...
                      <form action="<?php echo e(route(Request::segment(2) . '.destroy', $sub->id)); ?>" method="POST"
                        ...
                        <tr class="valign-middle bg-gray-light">
                          ...
                          <td>
                            ...
                            - - - - <input data-url="  <?php echo e(route('admin.loadOrderVeryModel',['table'=>'block_contents','id'=>$sub->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($sub->iorder?$sub->iorder:0); ?>" style="width:50px" />
                          </td>
                          <td>
                          ...
                          <td class="wrap-load-active" data-url="<?php echo e(route('admin.block_contents.load.status',['id'=>$sub->id])); ?>">
                            <?php echo $__env->make('admin.components.load-change-status',['data'=>$sub,'type'=>'Khối nội dung'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                          </td>
                          <td>
                            <a class="btn btn-sm btn-warning" data-toggle="tooltip" title="<?php echo app('translator')->get('Edit'); ?>"
                              data-original-title="<?php echo app('translator')->get('Edit'); ?>"
                          ...
                          <form action="<?php echo e(route(Request::segment(2) . '.destroy', $sub_child->id)); ?>" method="POST"
                            ...
                            <tr class="valign-middle bg-gray-light">
                              ...
                              <td>
                                ...
                                - - - - - - <input data-url="  <?php echo e(route('admin.loadOrderVeryModel',['table'=>'block_contents','id'=>$sub_child->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($sub_child->iorder?$sub_child->iorder:0); ?>" style="width:50px" />
                              </td>
                              <td>
                              ...
                              <td class="wrap-load-active" data-url="<?php echo e(route('admin.block_contents.load.status',['id'=>$sub_child->id])); ?>">
                                <?php echo $__env->make('admin.components.load-change-status',['data'=>$sub_child,'type'=>'Khối nội dung'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                              </td>
                              <td>
                                <a class="btn btn-sm btn-warning" data-toggle="tooltip" title="<?php echo app('translator')->get('Edit'); ?>"
                                  data-original-title="<?php echo app('translator')->get('Edit'); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\honey\resources\views/admin/pages/block_contents/index.blade.php ENDPATH**/ ?>