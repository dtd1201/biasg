                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[description][<?php echo e($lang); ?>]" id="description" class="form-control" rows="5"><?php echo e(old('description') ?? ($detail->json_params->description->$lang??( $detail->json_params->description->$lang ?? $detail->description))); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="brief" id="brief" class="form-control" rows="5"><?php echo e(old('brief') ?? ($detail->json_params->brief->$lang??( $detail->json_params->brief->$lang ?? $detail->brief))); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Content'); ?></label>
                                            <textarea name="content" id="content" class="form-control" rows="5"><?php echo e(old('content') ?? ($detail->json_params->content->$lang??( $detail->json_params->content->$lang ?? $detail->content))); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <form action="<?php echo e(route(Request::segment(2) . '.store')); ?>" method="POST" id="form-main"
                                ...
                                <div class="d-flex-wap">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Description'); ?></label>
                                            <textarea name="json_params[description][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]" class="form-control" rows="5"><?php echo e(old('description') ?? ''); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Brief'); ?></label>
                                            <textarea name="json_params[brief][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]" class="form-control" rows="5"><?php echo e(old('brief') ?? ''); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Content'); ?></label>
                                            <textarea name="json_params[content][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]" class="form-control" rows="5"><?php echo e(old('content') ?? ''); ?></textarea>
                                        </div>
                                    </div>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-md-6">
                                                                                                    <div
                                                                                                        class="form-group">
                                                                                                        <label><?php echo app('translator')->get('Description'); ?></label>
                                                                                                        <textarea name="json_params[description][<?php echo e($lang); ?>]"  class="form-control" rows="5"><?php echo e(old('description') ?? ( $item_sub_1->json_params->description->$lang ?? $item_sub_1->description)); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\biasg\resources\views/admin/pages/block_contents/edit/introduce.blade.php ENDPATH**/ ?>