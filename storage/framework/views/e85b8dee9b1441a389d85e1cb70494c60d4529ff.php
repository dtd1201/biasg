                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="json_params[description][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]"
                            class="form-control" rows="5"><?php echo e(old('json_params[description][' . $lang != '' ? $lang : $languageDefault->lang_code . ']')); ?></textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
                      <div class="form-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\honey\resources\views/admin/pages/cms_taxonomys/create.blade.php ENDPATH**/ ?>