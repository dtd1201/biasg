                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <textarea name="description" id="description" class="form-control" rows="5">{{ old('description') ?? ($detail->json_params->description->$lang??( $detail->json_params->description->$lang ?? $detail->description)) }}</textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
