    ...
    <section id="category-post">
      <div class="container container-1160">
          ...
          <div class="row">
                        ...
                        <div class="post-item-des">
                            <div class="post-info-box">
                                ...
                                <div class="post-count-share">
                                    <span>Ngày <?php echo e($date); ?>, <?php echo e($year); ?></span>
              ...
              <div class="box-btn">
                <a href="<?php echo e($alias); ?>" class="btn btn-see-more"><?php echo app('translator')->get('See more'); ?></a>
              </div>
          </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\biasg\resources\views/frontend/pages/post/category.blade.php ENDPATH**/ ?>