                            ...
                            <form action="{{ route(Request::segment(2) . '.store') }}" method="POST" id="form-main"
                                ...
                                <div class="d-flex-wap">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('Brief')</label>
                                            <textarea name="brief" class="form-control" rows="5">{{ old('json_params[brief]['.$lang.']') ?? ($detail->json_params->brief->$lang ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('Content')</label>
                                            <textarea name="content" class="form-control" rows="5">{{ old('json_params[content]['.$lang.']') ?? ($detail->json_params->content->$lang ?? '') }}</textarea>
                                        </div>
                                    </div>
                                                                                    ...
                                                                                    <div class="tab-pane active"
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    <label>@lang('Description')</label>
                                                                                                    <textarea name="json_params[description][{{$lang}}]" id="description" class="form-control" rows="5">{{ old('description') ?? ($item_sub_1->json_params->description->$lang??( $item_sub_1->json_params->description->$lang ?? $item_sub_1->description)) }}</textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <div class="form-group">
