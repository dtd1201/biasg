              ...
              <form action="<?php echo e(route(Request::segment(2).'.destroy', $row->id)); ?>" method="POST"
                ...
                <tr class="valign-middle">
                  ...
                  <td>
                    ...
                    <input data-url="<?php echo e(route('admin.loadOrderVeryModel',['table'=>'roles','id'=>$row->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($row->iorder?$row->iorder:0); ?>" style="width:50px" />
                  </td>
                  <td>
                  ...
                  <td class="wrap-load-active" data-url="<?php echo e(route('admin.roles.load.status',['id'=>$row->id])); ?>">
                    <?php echo $__env->make('admin.components.load-change-status',['data'=>$row,'type'=>'quyền'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                  </td>
                  <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\honey\resources\views/admin/pages/roles/index.blade.php ENDPATH**/ ?>