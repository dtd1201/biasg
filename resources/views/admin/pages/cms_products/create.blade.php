                ...
                <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div id="image_background_video-holder" style="margin-top:15px;max-height:100px;">
                            @if (old('image_background_video') != '')
                              <img style="height: 5rem;" src="{{ old('image_background_video') }}">
                            @endif
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="json_params[link_yt]"
                            placeholder="Link youtube" value="{{ old('json_params[link_yt]') }}">
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div id="image_logo-holder" style="margin-top:15px;max-height:100px;">
                            @if (old('image_logo') != '')
                              <img style="height: 5rem;" src="{{ old('image_logo') }}">
                            @endif
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div id="image_background_top-holder" style="margin-top:15px;max-height:100px;">
                            @if (old('image_background_top') != '')
                              <img style="height: 5rem;" src="{{ old('image_background_top') }}">
                            @endif
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div id="image_background_bottom-holder" style="margin-top:15px;max-height:100px;">
                            @if (old('image_background_bottom') != '')
                              <img style="height: 5rem;" src="{{ old('image_background_bottom') }}">
                            @endif
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="json_params[description][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control"
                            id="description_vi">{{ old('json_params[description][' . $lang != '' ? $lang : $languageDefault->lang_code . ']') }}</textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
