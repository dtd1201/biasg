                  ...
                  <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                    <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                      ...
                      <tr class="valign-middle">
                        <?php if(isset($row->json_params->title->$lang)): ?>
                        <td>
                          <strong style="font-size: 14px;"><?php echo e($row->json_params->title->$lang); ?></strong>
                        </td>
                        <?php else: ?>
                        <td>
                        ...
                        <td class="wrap-load-hot" data-url="<?php echo e(route('admin.cms_taxonomys.load.isFeatured',['id'=>$row->id])); ?>">
                          <?php echo $__env->make('admin.components.load-change-is_featured',['data'=>$row,'type'=>'danh mục'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </td>
                        <td>
                          
                          <input data-url="<?php echo e(route('admin.loadOrderVeryModel',['table'=>'cms_taxonomys','id'=>$row->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($row->iorder?$row->iorder:0); ?>" style="width:50px" />
                        </td>
                        <td>
                        ...
                        <td class="wrap-load-active" data-url="<?php echo e(route('admin.cms_taxonomys.load.status',['id'=>$row->id])); ?>">
                          <?php echo $__env->make('admin.components.load-change-status',['data'=>$row,'type'=>'danh mục'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </td>
                        <td>
                      ...
                      <?php if($sub->parent_id == $row->id): ?>
                        <form action="<?php echo e(route(Request::segment(2) . '.destroy', $sub->id)); ?>" method="POST"
                          ...
                          <tr class="valign-middle bg-gray-light">
                            <?php if(isset($sub->json_params->title->$lang)): ?>
                            <td> 
                              - - - - <?php echo e($sub->json_params->title->$lang); ?>
                            ...
                            <td class="wrap-load-hot" data-url="<?php echo e(route('admin.cms_taxonomys.load.isFeatured',['id'=>$sub->id])); ?>">
                              <?php echo $__env->make('admin.components.load-change-is_featured',['data'=>$sub,'type'=>'danh mục'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </td>
                            <td>
                              
                              - - - - <input data-url="<?php echo e(route('admin.loadOrderVeryModel',['table'=>'cms_taxonomys','id'=>$sub->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($sub->iorder?$sub->iorder:0); ?>" style="width:50px" />
                            </td>
                            <td>
                            ...
                            <td class="wrap-load-active" data-url="<?php echo e(route('admin.cms_taxonomys.load.status',['id'=>$sub->id])); ?>">
                              <?php echo $__env->make('admin.components.load-change-status',['data'=>$sub,'type'=>'danh mục'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </td>
                            <td>
                              <a class="btn btn-sm btn-warning" data-toggle="tooltip" title="<?php echo app('translator')->get('Update'); ?>"
                                data-original-title="<?php echo app('translator')->get('Update'); ?>"
                        ...
                        <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($sub_child->parent_id == $sub->id): ?>
                            <form action="<?php echo e(route(Request::segment(2) . '.destroy', $sub_child->id)); ?>" method="POST"
                              onsubmit="return confirm('<?php echo app('translator')->get('confirm_action'); ?>')">
                              <tr class="valign-middle bg-gray-light">
                                <?php if(isset($sub_child->json_params->title->$lang)): ?>
                                <td>
                                  - - - - - -<?php echo e($sub_child->json_params->title->$lang); ?>
                                ...
                                <td class="wrap-load-hot" data-url="<?php echo e(route('admin.cms_taxonomys.load.isFeatured',['id'=>$sub_child->id])); ?>">
                                  <?php echo $__env->make('admin.components.load-change-is_featured',['data'=>$sub_child,'type'=>'danh mục'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </td>
                                <td>
                                  
                                  - - - - - -<input data-url="<?php echo e(route('admin.loadOrderVeryModel',['table'=>'cms_taxonomys','id'=>$sub_child->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($sub_child->iorder?$sub_child->iorder:0); ?>" style="width:50px" />
                                </td>
                                <td>
                                ...
                                <td class="wrap-load-active" data-url="<?php echo e(route('admin.cms_taxonomys.load.status',['id'=>$sub_child->id])); ?>">
                                  <?php echo $__env->make('admin.components.load-change-status',['data'=>$sub_child,'type'=>'danh mục'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </td>
                                <td>
                                  <a class="btn btn-sm btn-warning" data-toggle="tooltip" title="<?php echo app('translator')->get('Update'); ?>"
                                    data-original-title="<?php echo app('translator')->get('Update'); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\biasg\resources\views/admin/pages/cms_taxonomys/index.blade.php ENDPATH**/ ?>