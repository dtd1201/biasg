        ...
        <div class="header-contact d-flex justify-content-end">
          ...
          <div class="search-button">
            <form class="top-search-form" action="<?php echo e(route('frontend.search.index')); ?>" method="get">
              ...
              <div class="icon">
                <img src="<?php echo e(asset('image/icon-search.png')); ?>" alt="search" />
              </div>
            </form>
          </div>
          <div class="img-lang">
            <?php $__currentLoopData = $menu_chil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if($item->sub <= 0): ?>
                ...
                <a href="<?php echo e($item->url_link); ?>"><img class="flag-<?php echo e($item->json_params->name->{$locale} ?? ($item->name ?? '')); ?>" src="<?php echo e($item->json_params->image); ?>" alt="<?php echo e($item->json_params->name->{$locale} ?? ($item->name ?? '')); ?>"></a>
                <?php endif; ?>
              <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\biasg\resources\views/frontend/blocks/header/styles/default.blade.php ENDPATH**/ ?>