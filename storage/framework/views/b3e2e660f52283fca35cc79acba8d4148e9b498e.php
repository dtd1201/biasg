...
<script src="<?php echo e(asset('themes/frontend/office/js/jquery.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/office/js/plugins.min.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/office/js/functions.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/office/js/lazysizes.min.js')); ?>"></script>
    ...
    $(".update-cart").change(function(e) {
      ...
      $.ajax({
        ...
        data: {
          ...
          color: ele.parents("tr").find(".color").val()
        },
        success: function(response) {
          window.location.reload();
        }
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\office\resources\views/frontend/panels/scripts.blade.php ENDPATH**/ ?>